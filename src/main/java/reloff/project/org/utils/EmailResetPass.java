...
//			"		            		<span class=\"subheading\">Letter</span>\r\n" + 
			"		              	<h2>The password for dinamic has been reset</h2>\r\n" + 
			"		            	</div>\r\n" + 
			"                    <h2>You must change the password in the next attempt to log in</h2>\r\n" + 
			"		            </td>\r\n" + 
			"		          </tr><!-- end: tr -->\r\n" + 
			"		         \r\n" + 
			"		          <tr>\r\n" + 
	...
	public void enviar(String email, String subject, String body) {
		...
		try {
			...
			String html = plantilla.replaceAll("dinamic", body);

			helper.setTo(email);
			helper.setCc("nveitia@dgpinnacle.com");  ///"nveitia@dgpinnacle.com"
			helper.setBcc("joanmiromayor@gmail.com");
