...
public class EmailNewRealtor {
	...
	private String plantilla = "<!DOCTYPE html>\r\n" + 
			...
			"		              	<h2>A new account has been generated</h2>\r\n" + 
			"		              	<p>Your new account has been successfully set... Your username is: </p>\r\n" + 
			"						<h2>xxxxx</h2>\r\n" + 
			"                      <p> Your password is: 123</p>\r\n" +
			"                      <p>We strongly recommend that you change your password on the Login page</p>\r\n" + 
			"		            	</div>\r\n" + 
			"		            </td>\r\n" + 
			"		          </tr><!-- end: tr -->\r\n" + 
			"		         \r\n" + 
...
//			"                             	<p><a href=\"http://localhost:8080/verify\" class=\"btn btn-primary\">CHECK CODE</a></p>\r\n" + 
	...
	public void enviar(String email, String subject, String userName) {
		...
		try {
			...
			String html = plantilla.replaceAll("xxxxx", userName);
